    ...
    label poemresponse_start2:
        ...
        menu:
            ...
            "Sayori" if not s_readpoem and persistent.playthrough == 0:
                ...
                call poemresponse_callback("sayori") from _call_poemresponse_callback
            ...
            "Natsuki" if not n_readpoem:
                ...
                call poemresponse_callback("natsuki") from _call_poemresponse_callback_1
            ...
            "Yuri" if not y_readpoem and not y_ranaway:
                ...
                call poemresponse_callback("yuri") from _call_poemresponse_callback_2
            ...
            "Monika" if not m_readpoem:
                ...
                call poemresponse_callback("monika") from _call_poemresponse_callback_3
...
label poemresponse_callback(character):
    ...
    call expression startscene from _call_expression

    if not skip_poem:
        call expression endscene from _call_expression_1
    return
