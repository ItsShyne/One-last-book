label chapter9:
    ...
    "Abro los ojos cuando el sol arroja su luz sobre mi cara."
    mc "Ugh..."
    ...
    "Él estaba entusiasmado por seguir trabajando con Yuri, y creo que él realmente puede ayudarla."
    "Me pregunto qué dirá él cuando ella le diga sobre sus cortes."
    "Yuri me prometió que iba a decírselo al doctor."
    "Así que, haré lo que pueda para apoyarla."

    scene bg kitchen
    with wipeleft_scene

    "Continúo mi camino hacia la cocina."
    ...
    mc "Oh... esto demuestra lo retrasado que soy."
    ...
    "Una vez más agarro mi teléfono y le envío un mensaje a Yuri."
    mc "{i}Voy caminando{/i}"
    "Casi inmediatamente, Yuri responde."
    y "{i}Okay. Estaré esperando.{/i} "
    "No estoy seguro de si Yuri siente que es necesario escribir tan formal, pero supongo que es un poco lindo."
    ...
    mc "Está bien que te sientas nerviosa. Solo recuerda, estaré todo el tiempo al lado de ti."
    ...
    "Llegamos al lugar. El Dr. Lankton está parado en la puerta esperándonos."
    ...
    d "..."
    y "*Suspiro* S-Sí..."
    d "Bien entonces acompáñame."
    mc "Hey Yuri."
    "Ella se voltea hacia mí con una expresión neutral."
    y 3cf "¿Qué pasa [Player]?"
    show yuri 3cs
    mc "Te estaré esperando como la vez pasada."
    show yuri zorder 2 at thide
    hide yuri
    "Asiente y ella entra con el doctor."
    mc "Te estaré esperando..."
    ...
    "Yuri al menos quiere cambiar, como su pareja es mi necesidad cuidarla."
    "Intento distraerme con el celular."
    mc "Que puedo ver..."
    "En los mensajes veo que ese número extraño me ha seguido mandando mensajes."
    "Podría bloquearla de todos modos."
    "Lo haré un día de estos."
    mc "Sería bueno saber cómo ser una buena pareja."
    "Busco algunas recomendaciones viendo videos."
    "Uno diciendo \"¿Cómo dejar de ser migajero?\""
    "En serio, esos videos parecen superación y estima más que conocer a tu pareja."
    ...
    d "No te preocupes, tómate el tiempo que sea necesario."
    "Es por mi bien tengo que hacerlo por mí, por [Player], no quiero decepcionarlo."
    "¿Por qué me siento en deuda con él?"
    "Eso me ha llevado a tomar decisiones sin pensar demasiado."
    "No debo decirle, quedaría destrozado..."
    "El doctor Lankton me sigue viendo."
    ####
    "*Suspiro.*"
    y "Yo... y-yo quiero mostrarle..."
    y "Hay... a-algo que aún no le he d-dicho a usted."
    "Dr. Lankton me mira curiosamente pero con frialdad de un profesional."
    ...
    "Mis ojos se sienten húmedos mientras que él anota de vez en cuando."
    "Eventualmente tuve lo que tenía que sacar."
    ...
    mc "¿Yuri, por qué no vamos a algún lugar a relajarnos?"
    ...
    mc "Hey Yuri, creo que ya sé qué podemos hacer."
    y 3cf "¿Y qué podemos--"
    y 3cp "¡Ahh!"
    show yuri zorder 1 at thide
    hide yuri
    ...
    "Ha pasado tanto tiempo desde la última vez que visité este lugar."
    mc "¡Aquí es!"
    ...
    "Una vez ella se cayó al río y tuve que saltar adentro y agarrarla."
    ...
    "Y solamente en ella."
    "Un rayo de luz, viajando millones de kilómetros solo para reflejarse en su rostro."
    ...
    y 3cf "..."
    "Yuri me mira como si acabara de empujarla a un portal."
    y 3ct "¿En serio...?"
    ...
    mc "Por supuesto."
    mc "Podemos preparar comida, tal vez algo de té, un libro, y vendríamos cuando esté soleado y sin nubes."
    y 3cj "Me..."
    y 3cb "Me gustaría."
    show yuri 3ca
    "Pongo mi brazo alrededor de Yuri."
    "Ella ni siquiera rechaza."
    "Puedo sentir su cuerpo tenso relajarse como si todos los momentos que han llevado a esto se hayan borrado de la existencia."
    ...
    y 3cq "¿Estás seguro?"
    mc "Quiero decir..."
    "Nop, no tendré esta conversación incómoda de nuevo."
    mc "¿Sabes qué? Me encantaría pasar la noche contigo."
    show yuri 3cf zorder 2 at t11
    y "¿En serio?"
    mc "¿Estás sorprendida porque quiero pasar el rato contigo?"
    ...
    #
    mc "Tienes un bonito sofá, ¿Te importa si me siento?"
    show yuri 3cg zorder 2 at t11
    y "Erm pues..."
    y 3ch "Estás algo sudoroso."
    "..."
    mc "Está bien..."
    mc "Entonces, ¿Dónde podría relajar las piernas?"
    y 3cf "Podría ser en la cocina."
    mc "Supongo que podemos descansar un rato y no sé..."
    mc "Leer o algo."
    y 3cd "Eso suena increíble."
    show yuri zorder 1 at thide
    hide yuri
    "Me dirijo a la cocina y me siento en una de las sillas que están en la mesa."
    "Al percatarme veo que hay sillas que sobran."
    mc "¿No te sientes sola?"
    show yuri 3cs zorder 2 at t11
    y "Algunas veces, pero contigo a veces se siente mejor."
    "Siento que la sangre se sube a mi cara."
    mc "En serio me gustaría quedarme más tiempo."
    mc "Pero no traje ropa para ducharme."
    y 3cq "Podrías...yo...quieres..."
    y 3ch "Creo que no sería buena idea."
    "Intento adivinar lo que quería decir."
    mc "¿Algo como prestarme tu ropa?"
    show yuri 3co zorder 2 at t11
    "Se ve que entendí lo que decía y mira hacia otro lado."
    "Mi rostro se pone caliente de nuevo."
    mc "Seee...Creo que tienes razón mejor cambiemos de tema."
    mc "¿Tu no te vas a bañar?"
    y 3cq "Uhh creo que tienes razón, discúlpame, mi casa es tu casa."
    "Yuri sube las escaleras sin antes darme una cálida sonrisa."
    "Supongo que podría ver su sala por un rato."
    "Paseo cerca de un estante y veo un retrato de sus padres y ella cuando era niña."
    "Incluso que los años pasaron sigue teniendo esa mirada inocente que tenía de pequeña."
    "Si hubiera estado mientras ella estaba teniendo esos problemas probablemente se abriría mejor."
    "Pero también tengo que abrirme con ella."
    ...
    mc "No es nada, te podría esperar cien años si es necesario."
    show yuri 3nu zorder 2 at t11
    "Hago que Yuri se sonroja un poco."
    "Buena esa [player]"
    "Sostengo una bandeja con la tetera y dos tazas pequeñas."
    mc "Pensé que podíamos sentarnos con el té mientras escuchamos la lluvia."
    "Yuri todavía no se había dado cuenta que estaba lloviendo afuera."
    ...
    "Insolación Infinita."
    "El libro con el que Yuri y yo hemos compartido estos últimos meses."
    "Un libro con una historia retorcida de pérdida que nos ha unido, y ahora estamos en el último capítulo."
    mc "Claro."
    show yuri 3nu
    "Estoy listo."
    show yuri zorder 2 at s11
    "Con las tazas de té en mano, tomamos nuestra posición habitual de lectura."
    "Sin embargo, nuestros cuerpos están más juntos."
    "Por un rato nos quedamos en silencio bebiendo, leyendo, y escuchando la lluvia."
    "Estamos en las últimas líneas del libro."
    ...
    mcnvl "No sé qué es peor si soy honesta."
    mcnvl "Estar rodeada de cuatro paredes de concreto, o el hecho de que estoy sola."
    mcnvl "Si solo hay una cosa que los humanos comparten; es el miedo a estar solo."
    ...
    nvl clear
    mcnvl "Miro a través de la pequeña ventana en lo alto de la celda."
    mcnvl "El sakura..."
    mcnvl "Está brillando."
    mcnvl "Debe ser primavera entonces."
    mcnvl "Eso significa que estoy aquí desde..."
    mcnvl "..."
    mcnvl "No estoy segura de cuánto."
    mcnvl "¿Cómo puedes medir el tiempo si ni siquiera puedes ver el sol?"
    nvl clear
    mcnvl "Observo mi brazo vendado."
    mcnvl "Me he visto a mí misma entrar en la locura, salir, y después volver a entrar en ella."
    mcnvl "Es como un ciclo."
    mcnvl "He estado tanto tiempo aquí que puedo saber cuándo empezaré a perder mi mente."
    mcnvl "Incluso mis alucinaciones no quieren hablarme más."
    nvl clear
    mcnvl "\"¡Boom, boom, boom!\""
    mcnvl "Se escucha un golpe monstruoso al otro lado de mi puerta."
    ...
    nvl clear
    mcnvl "Permanezco en el centro de la habitación, mi corazón late fuertemente."
    ...
    mcnvl "El sonido de un metal raspándose suena y llena la habitación."
    mcnvl "Apago mis oídos instintivamente, pero mis ojos nunca se apartan de la puerta."
    mcnvl "Cierro mi respiración."
    ...
    show yuri 3nl
    "Una vez que el té se acabó, Yuri suelta un bostezo."
    mc "¿Cansada?"
    y 3nm "Ujumm."
    "Nos deslizamos uno al lado del otro mientras escuchamos el mundo exterior."
    "La melódica sinfonía de las gotas cayendo en el techo es relajante."
    y "¿[player]?"
    mc "¿Sí?"
    ...
    mc "Fue cuando era realmente joven, así que no recuerdo lo específico de ello."
    mc "Sin embargo, recuerdo que mis padres me sentaron, y me dijeron que se estaban separando."
    mc "Me hicieron elegir con quien quería vivir de los dos."
    mc "Sé que se ve que es mucho para un niño, pero ellos querían estar seguros de lo que era mejor para mí."
    mc "Al final, decidí quedarme con mi padre y pues mi madre se fue."
    y "Lo siento..."
    mc "Está bien."
    mc "Fue hace mucho tiempo."
    mc "Después de que mi mamá se fue ella consiguió un trabajo en una gran compañía banquera y se mudó."
    ...
    mc "Después de eso él se encuentra ahora en servicio militar."
    ...
    y "¿Él te dejó?"
    mc "Básicamente."
    mc "Después de la caída del negocio, no podía darse el lujo de criarme, y con mi madre en otra parte del mundo tampoco podía estar allí para mí."
    mc "Así que la única forma de que mi padre ganase dinero era meterse al servicio militar."
    mc "Le dan cheques, la mayoría de los cuales van a la casa por facturas y cosas."
    mc "Y con el dinero que mi madre me da puedo comprar comida y otros productos de necesidad."
    mc "No es mucho, pero es suficiente para sobrevivir sin luchar."
    mc "Bueno...físicamente estoy bien, pero a veces me siento algo solo."
    ...
    "Yuri me mira tímidamente mientras sigue sentada."
    ...
    mc "Yo te amo, Yuri."
    "Allí está esa palabra de nuevo."
    "Una palabra a la cual no puedo entender su significado."
    "Pero igualmente la digo."
    "Porque realmente es la única palabra que no puedo sacar de mi mente."
    "Yuri me acompaña hacia la puerta y me presta su paraguas."
    "Su suave voz me despide combinada con el sonido del viento húmedo y el chapotear de las gotas."
    "Giro viendo por última vez sus ojos violetas."
    "Y lo único que me acompaña es el perfume impregnado en su paraguas."
