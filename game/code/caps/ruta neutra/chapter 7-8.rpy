label chapter7:
    ...
    mc "Ugh..."
    "Miro hacia mi izquierda para ver el despertador de mi teléfono sonar."
    ...
    "No quiero llegar tarde al último día de clases."
    "Escribo un mensaje a Yuri de la fecha."
    "Ella responde de manera tranquila y acordamos para desayunar en mi casa."
    "Durante la temporada de vacaciones tenemos un par de semanas libres de la escuela."
    "Así podré estar más tiempo con Yuri."
    "Muestro una ligera sonrisa."
...
#hasta aca
    ...
    n "¿No puedes solo pasar por su casa camino a tu casa?"
    "Pienso para mí."
    #asddfgrrgbfgg??????????????????????????????????
    "Sería moralmente incorrecto para mí dejar que Natsuki se quede sin hogar."
    "No me haría problema preguntar."
    ...
    mc "..."
    n "..."
    "Creo que la conversación ya terminó."
    ...
    s 1bg "¿Pero qué es de su padre?"
    mc "Él tiene ciertos problemas que hicieron que Natsuki tenga que separarse."
    show sayori 1bk
    "Sigo contándole a Sayori lo demás de mi encuentro con Natsuki."
    ...
    "Nos despedimos de nuevo y esta vez sin apoyar los dedos"
    ...
    "Me despierto dentro de la comodidad de mis cobijas."
    "El primer día de descanso, cuando cada estudiante se olvida del mundo."
    "Me tomo un momento para mirar mi techo; el resplandor de la mañana asomándose por mis persianas."
    ...
    "Eso hace que haya un silencio incómodo mientras como."
    mc "También está la opción de no aceptar Yuri no tengas miedo."
    ...
    "Ya no veo a Yuri como la chica se presenta a sí misma como tímida."
    ...
    "Y, por supuesto, la suerte estaba relacionada con si tenía o no la película a la mano."
    ...
    "La película está muy buena, pero mi visión se desvía hacia Yuri inconscientemente."
    ...
    y 2bh "Aunque, no pude evitar notar todas las diferencias del libro."
    mc "¿Cómo qué?"
    ...
    show yuri zorder 1 at thide
    hide yuri
    "Pasamos un silencio cómodo y ella se desvanece en los postes y la oscuridad de la noche."
    ...
    "Supongo que tendremos que ver a dónde más caminamos."
