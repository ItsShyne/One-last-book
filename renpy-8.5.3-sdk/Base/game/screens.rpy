        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                if persistent.playthrough == 1:
                    ...
                    textbutton _("Nuevo Juego") action If(persistent.playername, true=Start(), false=Show(screen="name_input", message="Por Favor Ingresa Tu Nombre", ok_action=Function(FinishEnterName)))
...
screen ddlc_preferences():
    hbox:
        ...
        vbox:
            ...
            textbutton _("Despues De decisiones") action Preference("after choices", "toggle")
    ...
    hbox:
        ...
        vbox:
            ...
            hbox:
                label _("Tiempo De Lectura-auto")
...
screen template_preferences():
    hbox:
        ...
        vbox:
            ...
            textbutton _("Change Name") action Show(screen="name_input", message="Por Favor Ingresa Tu NOm", ok_action=Function(FinishEnterName, launchGame=False)):
